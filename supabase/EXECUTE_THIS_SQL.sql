...
-- 13. DADOS INICIAIS - Perguntas do quiz
...
-- 14. Usuário de teste para desenvolvimento
INSERT INTO auth.users (id, email) VALUES ('00000000-0000-0000-0000-000000000001', 'teste@iasurviver.com') ON CONFLICT DO NOTHING;
INSERT INTO public.users (id, email, name, plan) VALUES ('00000000-0000-0000-0000-000000000001', 'teste@iasurviver.com', 'Usuário Teste', 'premium') ON CONFLICT DO NOTHING;
